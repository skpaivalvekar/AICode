...
markdown_object = create_brochure("Infosys", "https://www.infosys.com/")

# Check if it's a Markdown object
if isinstance(markdown_object, Markdown):
    markdown_text = markdown_object.data
    print(markdown_text)  # This will print the raw Markdown string
else:
    print(markdown_object) # If it's already a string, just print it
